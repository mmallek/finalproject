...
\hline
Variable & \multirow{2}{*}{\parbox{2cm}{Variable Definitions}}  & Min & Median & Mean & Max & \multirow{2}{*}{\parbox{2cm}{Missing Values}} & 95\% CI for Mean & 95\% CI for Median\\
 & & & & & & & & \\
\hline
...
weeks & gestational age & 20 & 39 & 38.33 & 45 & 2 & (38.15187, 38.51747) & (7.886806,9.40128) \\
visits & hospital visits & 0 & 12.0 & 12.1 & 30 & 9 \\
%gained & \multirow{2}{*}{weight gained} & 0 & 30 & 30.33 & 85 & 27 \\
%&  by mother & & & & & \\
gained & \multirow{2}{*}{\parbox{3cm}{weight gained by mother}} & 0 & 30 & 30.33 & 85 & 27 \\
 & & & & & & & & \\
weight & birth weight of baby & 1 & 7.31 & 7.101 & 11.750 & 0 \\
\end{tabular}
...
<<binplot, echo=FALSE, fig.height=3, fig.width=6, warning=FALSE, fig.cap='Plots of continuous variable vs. binary variable; generated to determine rules for creating binary variables since this information was omitted from the metadata.', message=FALSE>>=
p1=qplot(mage, mature, xlab="Maturity of mother by age (years)", ylab=NULL)
p2=qplot(weeks, premie, xlab="Gestation period (weeks)???", ylab=NULL)
p3=qplot(weight, lowbirthweight, xlab="Weight of baby (lbs)", ylab=NULL) + geom_vline(x=5.51)
...
# 95 percent CI for mean
# lower bound, upper bound
mean(weeks,na.rm=TRUE) - qnorm(.975)*(sd(weeks,na.rm=TRUE)/sqrt(988))
mean(weeks,na.rm=TRUE) + qnorm(.975)*(sd(weeks,na.rm=TRUE)/sqrt(988))
